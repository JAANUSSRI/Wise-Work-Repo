...
namespace FuncActionPredicateExamples
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Func is a generic delegate , here it takes 2 input parameters and returns a value
            Func<decimal, decimal, decimal> calculateTotalAnnualSalary = 
                    (annualSalary, bonusPercentage) => 
            ...
            //Action delegate to display employee details
